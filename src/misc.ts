 ...
 */
export const capWords = (str: string) => str.replace(/\b[a-z]/g, char => char.toUpperCase())
...
export const dayOfYear = (date: Date) => Math.floor((date.getTime() - new Date(date.getFullYear(), 0, 0).getTime()) / 1000 / 60 / 60 / 24);
